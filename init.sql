...
$$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'pockguy96') THEN
        CREATE USER pockguy96 WITH PASSWORD '123456';
    END IF;
END
$$;
...
$$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_database WHERE datname = 'ft') THEN
        CREATE DATABASE ft;
    END IF;
END
$$;
...
GRANT ALL PRIVILEGES ON DATABASE ft TO pockguy96;
